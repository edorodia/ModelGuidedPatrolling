...
# Load the model
model = EncoderDecoder(input_size=dataset[0][0].shape, latent_size=256, output_channels=1, loss_weights = None).to(device)
#model.load_state_dict(th.load('runs\TrainingVAE\VAE_Algae_20230525-224602\VAE_static_algae_8.pth'))
model.load_state_dict(th.load('runs\TrainingEncoderDecoder\EncDec_Algae_20230526-161849\EncDec_static_algae_train.pth'))
