...
comb_type_model_1 = model_name + "_-_False_False_none"										#combination type of the model trained

trained_model_folder_model_1 = "runs-2_Completed_epoch_50_" + comb_type_model_1		#name of the folder runs if edited

VAEUnet_folder_model_1 = "VAEUnet_shekel_20240806-111730"								#internal name of variable name folder
...
np.save('step_list_'+ model_name +'.npy', step_list_total)
np.save('step_mse_'+ model_name +'.npy', np.mean(step_mse_total, axis = 0))
np.save('step_rmse_'+ model_name +'.npy', np.mean(step_rmse_total, axis = 0))
np.save('step_w_rmse_'+ model_name +'.npy', np.mean(step_w_rmse_total, axis = 0))
