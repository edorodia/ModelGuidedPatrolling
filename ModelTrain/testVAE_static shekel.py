...
# Create the dataset
dataset = StaticDataset(path_trajectories = 'ModelTrain/Data/trajectories_static_test.npy',
...
model.load_state_dict(th.load('runs\TrainingVAE\VAE_Shekel_20230525-215913\VAE_static_shekel_18.pth'))
