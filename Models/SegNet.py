...
class SegNet(nn.Module):
    ...
    def __init__(self, input_size, latent_size, output_channels=1, loss_weights = None):
        ...
        self.in_chn = input_size[0]
        self.out_chn = output_channels
        ...
        self.final_layer = nn.AdaptiveAvgPool2d(output_size=input_size[1:3]) #output_size=(H,W)
    ...
    def loss(self, x, x_hat, mu, logvar, mask=None):
        ...
        if mask is not None:
            ...
            recon_loss = torch.nn.functional.mse_loss(x_hat * mask, x * mask, reduction='sum') / mask.sum()
        else:
